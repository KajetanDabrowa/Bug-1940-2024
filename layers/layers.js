...
var format_siatka_sent_hist_8 = new ol.format.GeoJSON();
var features_siatka_sent_hist_8 = format_siatka_sent_hist_8.readFeatures(json_siatka_sent_hist_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_siatka_sent_hist_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_siatka_sent_hist_8.addFeatures(features_siatka_sent_hist_8);
var lyr_siatka_sent_hist_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_siatka_sent_hist_8, 
                style: style_siatka_sent_hist_8,
                popuplayertitle: 'siatka_sent_hist',
                interactive: true,
    title: 'siatka_sent_hist<br />\
    <img src="styles/legend/siatka_sent_hist_8_0.png" /> -100 - -60<br />\
    <img src="styles/legend/siatka_sent_hist_8_1.png" /> -60 - -30<br />\
    <img src="styles/legend/siatka_sent_hist_8_2.png" /> -30 - 0<br />\
    <img src="styles/legend/siatka_sent_hist_8_3.png" /> 0 - 30<br />\
    <img src="styles/legend/siatka_sent_hist_8_4.png" /> 30 - 60<br />\
    <img src="styles/legend/siatka_sent_hist_8_5.png" /> 60 - 100<br />'
        });

lyr_Raster_0.setVisible(true);lyr_koryto_rzeki_historyczne_1940_1.setVisible(false);lyr_koryto_rzeki_vMap_2000_2.setVisible(false);lyr_koryto_rzeki_Sentinel_2024_3.setVisible(false);lyr_koryto_rzeki_kiedykolwiek_4.setVisible(true);lyr_koryto_rzeki_zawsze_5.setVisible(true);lyr_siatka_Hist_Vmap_6.setVisible(false);lyr_siatka_VMap_Sent_7.setVisible(false);lyr_siatka_sent_hist_8.setVisible(false);
var layersList = [lyr_Raster_0,lyr_koryto_rzeki_historyczne_1940_1,lyr_koryto_rzeki_vMap_2000_2,lyr_koryto_rzeki_Sentinel_2024_3,lyr_koryto_rzeki_kiedykolwiek_4,lyr_koryto_rzeki_zawsze_5,lyr_siatka_Hist_Vmap_6,lyr_siatka_VMap_Sent_7,lyr_siatka_sent_hist_8];
...
lyr_siatka_sent_hist_8.set('fieldAliases', {'OBJECTID_12_13': 'OBJECTID_12_13', 'GRID_ID': 'GRID_ID', 'OBJECTID': 'OBJECTID', 'GRID_ID_1': 'GRID_ID', 'AREA': 'AREA', 'PERCENTAGE': 'PERCENTAGE', 'OBJECTID_1': 'OBJECTID', 'GRID_ID_12': 'GRID_ID', 'AREA_1': 'AREA', 'PERCENTAGE_1': 'PERCENTAGE', 'OBJECTID_12': 'OBJECTID', 'GRID_ID_12_13': 'GRID_ID', 'AREA_12': 'AREA', 'PERCENTAGE_12': 'PERCENTAGE', 'procent_hist_vmap': 'procent_hist_vmap', 'procent_vmap_sent': 'procent_vmap_sent', 'procent_sent_hist': 'procent_sent_hist', 'Shape_Length': 'Shape_Length', 'Shape_Area': 'Shape_Area', });
...
lyr_siatka_sent_hist_8.set('fieldImages', {'OBJECTID_12_13': 'TextEdit', 'GRID_ID': 'TextEdit', 'OBJECTID': 'Range', 'GRID_ID_1': 'TextEdit', 'AREA': 'TextEdit', 'PERCENTAGE': 'TextEdit', 'OBJECTID_1': 'Range', 'GRID_ID_12': 'TextEdit', 'AREA_1': 'TextEdit', 'PERCENTAGE_1': 'TextEdit', 'OBJECTID_12': 'Range', 'GRID_ID_12_13': 'TextEdit', 'AREA_12': 'TextEdit', 'PERCENTAGE_12': 'TextEdit', 'procent_hist_vmap': 'TextEdit', 'procent_vmap_sent': 'TextEdit', 'procent_sent_hist': 'TextEdit', 'Shape_Length': 'TextEdit', 'Shape_Area': 'TextEdit', });
...
lyr_siatka_sent_hist_8.set('fieldLabels', {'OBJECTID_12_13': 'hidden field', 'GRID_ID': 'hidden field', 'OBJECTID': 'hidden field', 'GRID_ID_1': 'hidden field', 'AREA': 'hidden field', 'PERCENTAGE': 'hidden field', 'OBJECTID_1': 'hidden field', 'GRID_ID_12': 'hidden field', 'AREA_1': 'hidden field', 'PERCENTAGE_1': 'hidden field', 'OBJECTID_12': 'hidden field', 'GRID_ID_12_13': 'hidden field', 'AREA_12': 'hidden field', 'PERCENTAGE_12': 'hidden field', 'procent_hist_vmap': 'hidden field', 'procent_vmap_sent': 'hidden field', 'procent_sent_hist': 'inline label - visible with data', 'Shape_Length': 'hidden field', 'Shape_Area': 'hidden field', });
lyr_siatka_sent_hist_8.on('precompose', function(evt) {
